...
class TestenglishToFrench(unittest.TestCase): 
    def test1(self): 
	    self.assertNotEqual(english_to_french("Hello"),"") # Test for the translation of the word Hello and Bonjour

class TestfrenchToEnglish(unittest.TestCase): 
    def test1(self): 
	    self.assertNotEqual(french_to_english("Bonjour"),"") # Test for the translation of the word Hello and Bonjour
